...
import dev.durgesh.BookMyShow.Service.TicketService;
import dev.durgesh.BookMyShow.dto.BookTicketRequestDTO;
...
public class TicketController {
    ...
    public ResponseEntity bookTicket(@RequestBody BookTicketRequestDTO bookTicketRequestDTO) throws Exception {
        ...
        return ResponseEntity.ok(
                ticketService.bookTicket(bookTicketRequestDTO.getShowSeatsIds(), bookTicketRequestDTO.getUserId())
        );
    }
